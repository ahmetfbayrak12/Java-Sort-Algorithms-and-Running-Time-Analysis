...
public class FindSecondLargest {
	...
	private static void createTree(ArrayList<Integer> arrayList, int firstSize)		// Creating tree structure and send it to findSecondLargest function.
	{
	...
	private static void findSecondLargest(ArrayList<Integer> arrayList, int size)		// Select winner and find the losers who lose against winner and add them to list then select to maximum of this list.
	{
